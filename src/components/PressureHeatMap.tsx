  ...
  return (
    <div className="flex flex-col items-center space-y-4 bg-card rounded-md p-4 shadow-sm">
      ...
      <div className="relative w-[220px] h-[400px]">
        ...
        >
          {/* Load the sensor paths based on side */}
          {side === 'left' ? (
            // Left foot sensors
            Object.entries(sensorData).map(([sensorId, pressure]) => {
              // Skip if sensor ID doesn't match our naming convention or pressure is zero
          ...
          {/* Region labels - only show on left foot to avoid mirrored text */}
          {side === 'left' && (
            <>
              <text x="95" y="380" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Heel</text>
              <text x="50" y="210" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Lateral Midfoot</text>
              <text x="170" y="210" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Medial Midfoot</text>
              <text x="110" y="100" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Forefoot</text>
              <text x="125" y="30" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Toes</text>
              <text x="240" y="80" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Hallux</text>
            </>
          )}
          
          {side === 'right' && (
            <>
              <text x="195" y="380" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Heel</text>
              <text x="246" y="210" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Lateral Midfoot</text>
              <text x="126" y="210" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Medial Midfoot</text>
              <text x="186" y="100" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Forefoot</text>
              <text x="176" y="30" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Toes</text>
              <text x="66" y="80" fontSize="12" textAnchor="middle" fill="white" fontWeight="bold">Hallux</text>
            </>
          )}
        </svg>
      </div>
...
const getSensorPath = (sensorId: string, side: 'left' | 'right'): string => {
  ...
  return side === 'left' ? (leftFootPaths[sensorId] || '') : (rightFootPaths[sensorId] || '');
};
