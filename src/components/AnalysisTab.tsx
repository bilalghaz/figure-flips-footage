  ...
  return (
    <div className="bg-card rounded-md shadow-sm p-4">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold">Average Pressure Analysis</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 border rounded-md flex flex-col justify-center">
          <h3 className="text-center font-medium mb-2">
            {showDifference ? 'Left-Right Difference (kPa)' : `Average ${pressureMode === 'peak' ? 'Peak' : 'Mean'} Pressure (kPa)`}
          </h3>
